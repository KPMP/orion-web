    ...
    render() {
    	...
    	return (
			<section className="package">
    			...
    			<MetadataModal show={this.state.showMetadata} uploadPackage={packageInfo} close={this.handleMetadataClick} currentDTD={this.props.currentDTD} getDTDByVersion={this.props.getDTDByVersion} dtds={this.props.dtds}/>
    		</section>
    	);
    }
}
