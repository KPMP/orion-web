            ...
            <div className="largeFileModal static-modal">
                <Modal size="lg" isOpen={this.props.show}>
                    ...
                    <ModalBody className="largeFileModalBody">
                        <ol>
                            <li>Click this link to <a href={this.props.link} target="_blank" rel="noopener noreferrer">open the destination folder</a> on the Globus endpoint. If you experience problems accessing the endpoint, contact <a target="_blank" rel="noopener noreferrer" href="mailto:datalakeuploadersupport@kpmp.org">datalakeuploadersupport@kpmp.org</a> to ensure you have access.</li>
